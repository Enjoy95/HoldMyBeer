...
class Database{
    ...
    /**
     * @return [type] this function is using PDO to connect to the DB
     */
    ...
    /**
     * @param mixed $str is what the user has typed in the search bar
     * 
     * @return [type] returning all the bars that contains $str in the "boissons" row
     */
    ...
    /**
     * @param mixed $str is the id of the bar we're looking in the query
     * 
     * @return [type] returning the bar with the id $str
     */
    ...
    /**
     * @param mixed $pseudo pseudo of the user who wrote the comment
     * @param mixed $texte text of the comment
     * @param mixed $date date of the new comment
     * @param mixed $id_bar bar where we're putting new comment
     * 
     */
    ...
    /**
     * @param mixed $int here the int is referrer to the id_bar in table Commentaire
     * 
     * @return [type] we're returning all the comments of the id_bar specified
     */
    ...
    /**
     * @param mixed $pseudo is the pseudo of the user we need to check if the bar has been already liked or no
     * @param mixed $id is the id of the bar we're checking if it's like or not
     * 
     * @return [type]
     */
    ...
    /**
     * @param mixed $pseudo is the pseudo of the user who is about to like 
     * @param mixed $id is the id of the bar we want to like
     * 
     */
    ...
    /**
     * @param mixed $pseudo is the pseudo of the user who is about to unlike 
     * @param mixed $id is the id of the bar we want to unlike
     * 
     */
    ...
    /**
     * @return [type] returning Bars order by their like count
     */
    ...
    /**
     * @param mixed $pseudo is the param we pass to the function in order to get favorite bar of the user with $pseudo  
     * 
     * @return [type] datas is returning favorite bars for specific user
     */
